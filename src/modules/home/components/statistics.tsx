...
export function Statistics() {
  return (
    <Section
      id={routes.home.sections.estadisticas.id}
      className="relative pb-20"
    >
      <div
        className="absolute inset-0 z-0"
        style={{
          backgroundImage: `url('${imageSrc(images["39c03d38"])}')`,
      ...
      <Container className="z-10 grid grid-cols-2 items-center justify-between gap-8 text-center md:grid-cols-4">
